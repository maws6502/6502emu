...
GO		LDX	OMOVE        	; OPENING?
		...
		LDA	DIS3         	; -YES WAS
		CMP.W	OPNING,X        ; OPPONENT'S
		BNE	END            	; MOVE OK?
		DEX	
		LDA.W	OPNING,X       	; GET NEXT
		STA	DIS1         	; CANNED
		DEX			; OPENING MOVE
		LDA.W	OPNING,X
		STA	DIS3         	; DISPLAY IT
...
POUT1		lDA   	#$7C		; print vert edge
		JSR   	putc	; PRINT ONE ASCII CHR - SPACE
		LDX   	#$1F
...
POUT5       	TXA			; print "-----...-----<crlf>"
		...
		LDX	#$19
		LDA	#$5f
POUT6		JSR   	putc	; PRINT ONE ASCII CHR - "-"
		DEX
		BNE	POUT6
		PLA
		TAX
...
POUT9      	LDA   	#$0D
		JSR   	putc	; PRINT ONE ASCII CHR - CR
        	LDA   	#$0A
		JSR   	putc	; PRINT ONE ASCII CHR - LF
                RTS 
